...
<head>
    ...
    <link rel="stylesheet"
          href="<?= CUtil::GetAdditionalFileURL(SITE_TEMPLATE_PATH . '/bootstrap/css/bootstrap.css', true) ?>">
    <!-- Optional theme -->
    <link rel="stylesheet"
          href="<?= CUtil::GetAdditionalFileURL(SITE_TEMPLATE_PATH . '/bootstrap/css/bootstrap-theme.css', true) ?>">
    <link rel="stylesheet" href="<?= CUtil::GetAdditionalFileURL(SITE_TEMPLATE_PATH . '/css/style.css', true) ?>">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.0.0/animate.min.css">
    <link rel="stylesheet"
          href="<?= CUtil::GetAdditionalFileURL(SITE_TEMPLATE_PATH . '/css/liquid-slider.css', true) ?>">
