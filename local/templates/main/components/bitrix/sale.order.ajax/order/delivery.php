...
<div class="bx_section deliveryes">
	<?
	if(!empty($arResult["DELIVERY"]))
	{
		...
		foreach ($arResult["DELIVERY"] as $delivery_id => $arDelivery)
		{
			if ($delivery_id !== 0 && intval($delivery_id) <= 0)
			{
				...
				{
					?>
					<div class="bx_block w100 vertical green_blue_bg">
					...
					<div class="bx_block w100 vertical green_blue_bg">
						...
						<div class="bx_element">
							...
							<label for="ID_DELIVERY_ID_<?=$arDelivery["ID"]?>" <?=$clickHandler?>>
								...
								<div class="bx_logotype col-xs-1"><img src="<?=$deliveryImgURL?>" class="img-responsive"></span></div>

								<div class="bx_description col-xs-5">
                                    ...
                                    <span class="bx_result_price col-xs-5">
                                        <div class="time col-xs-6">
                                        <?
                                        if (strlen($arDelivery["PERIOD_TO"])>0)
                                        {
                                            echo ($arDelivery["PERIOD_TEXT"])?$arDelivery["PERIOD_TEXT"]:"&nbsp;";
                                        }
                                        ?>
                                        </div>
                                        <div class="del-price col-xs-6">
                                            <b><?=$arDelivery["PRICE_FORMATED"]?></b>
                                        </div>
									</span>
							</label>
