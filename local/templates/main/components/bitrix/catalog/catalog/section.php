...
?>
    ...
    <div class="main_content_block clearfix col-xs-12">
        <?$intSectionID = $APPLICATION->IncludeComponent(
            ...
            ($_REQUEST['template']=='list')?'list':"table",
            array(
                "IBLOCK_TYPE"                     => $arParams["IBLOCK_TYPE"],
                "IBLOCK_ID"                       => $arParams["IBLOCK_ID"],
                "ELEMENT_SORT_FIELD"              => ($_REQUEST['sort'])?$_REQUEST['sort']:$arParams["ELEMENT_SORT_FIELD"],
...
?>
<?
    if (\Bitrix\Main\ModuleManager::isModuleInstalled("sale") && false) {
        $arRecomData = array();
